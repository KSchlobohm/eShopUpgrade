...
namespace eShopLegacyMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public SignInManager<ApplicationUser> SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.RequestServices.GetService<SignInManager<ApplicationUser>>();
            }
            private set
            {
        ...
        public UserManager<ApplicationUser> UserManager
        {
            get
            {
                return _userManager ?? HttpContext.RequestServices.GetService<UserManager<ApplicationUser>>();
            }
            private set
            {
                _userManager = value;
        ...
        // Removed OWIN AuthenticationManager as it's not supported in ASP.NET Core
        // ASP.NET Core has its own authentication system which is used directly
